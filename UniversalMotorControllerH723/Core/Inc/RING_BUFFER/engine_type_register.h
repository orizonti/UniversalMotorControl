...
public:
      ...
      static int RegisterType(int ID)
      { 
			    if(TYPE_ID > 0)   return TYPE_ID; // ALREADY REGISTERED
            TypeRegister<>::TypeCount++; TYPE_ID = ID;
